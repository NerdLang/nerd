...
{
  public:
    vector<shared_ptr<pair<char*, var>>>* __NJS_OBJECT = new vector<shared_ptr<pair<char*, var>>>();
    var Get(char* _index);
};
...
inline var __NJS_Object_Set(char* _index, var _value, var _array)
{
  ...
  else if(_array.type == STRING) _obj = _array.value.s->__NJS_OBJECT;
...
inline var __NJS_Object_Set(var _index, var _value, var _array)
{
  if(_array.type == ARRAY)
  {
    ...
    __NJS_Object_Set(__create_String((char*)"length"), __create_Number(_obj->size()), _array.value.a->__NJS_OBJECT);
  }
...
__NJS_Class_String::__NJS_Class_String(char* _value)
{
  ...
  __NJS_Object_Set((char*)"toString", toString, this->__NJS_OBJECT);

  __NJS_Object_Set((char*)"length", var(strlen(_value)), this->__NJS_OBJECT);
...
{
  return __NJS_Object_Get(_index, this->__NJS_OBJECT);
}
...
__NJS_Class_Array::__NJS_Class_Array(vector<var>* _value)
{
  ...
  __NJS_Object_Set((char*)"length", __create_Number(_value->size()), this->__NJS_OBJECT);
...
inline void __NJS_Call_Function(var _var) { (*static_cast<function<var ()>*>(_var.value.f))(); }
inline void __NJS_Call_Function(var _var, var _arg1) { (*static_cast<function<var (var _arg1)>*>(_var.value.f))(_arg1); }
inline void __NJS_Call_Function(var _var, var _arg1, var _arg2) { (*static_cast<function<var (var _arh1, var _arg2)>*>(_var.value.f))(_arg1, _arg2); }
inline void __NJS_Call_Function(var _var, var _arg1, var _arg2, var _arg3) { (*static_cast<function<var (var _arg1, var _arg2, var _arg3)>*>(_var.value.f))(_arg1, _arg2, _arg3); }
inline void __NJS_Call_Function(var _var, var _arg1, var _arg2, var _arg3, var _arg4) { (*static_cast<function<var (var _arg1, var _arg2, var _arg3, var _arg4)>*>(_var.value.f))(_arg1, _arg2, _arg3, _arg4); }

static var NECTARJS = var(BOOLEAN, 1);
var __NJS_ARGS = __create_Array(new vector<var>());
...
int main(int argc, char* argv[])
{
  ...
  {
     __NJS_Object_Set(var(i), __create_String(argv[i]), __NJS_ARGS);
  }
	__MAIN__
}
